                                    ...
                                    <td style="width: auto; padding: 5px; text-align: left; vertical-align: top">
                                        ...
                                        <div style="width: 540px;">
                                            <table>
                                                <tr>
                                                    <td>
                                                        Client:&nbsp;<asp:DropDownList ID="ddClientNameSearch" runat="server" Width="180px"></asp:DropDownList>&nbsp;
                                                        ...
                                                        <div>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox TextMode="Date" ID="txtCompleteDTFrom" runat="server" ReadOnly="true" Width="100px" ></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        &nbsp;to&nbsp;</td>
                                                                    <td>
                                                                        <asp:TextBox TextMode="Date" ID="txtCompleteDTTo" runat="server" Width="100px" ReadOnly="true" ></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>
                                                        Status:&nbsp;<asp:DropDownList ID="ddTRStatusSearchList" runat="server" Width="200px"></asp:DropDownList>
                                                ...
                                                <tr>
                                                    <td>
                                                        Team:&nbsp;<asp:DropDownList ID="ddTeamSearchList" runat="server" Width="200px">
                    ...
                    <div id="pnlInput" runat="server"  style="padding-left: 5px; width:550px; padding:9px; border-style:solid; border-width:medium; border-color: darkblue; border-radius: 8px;">
                            ...
                            <tr>
                                <td>
                                    Start&nbsp;Date:</td>
                                <td>
                                    <asp:TextBox TextMode="DateTime" ID="txtStartDate" runat="server" ReadOnly="true"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    Completed&nbsp;Date:</td>
                                <td>
                                    <asp:TextBox TextMode="DateTime" ID="txtCompleteDate" runat="server" ReadOnly="true" ></asp:TextBox>

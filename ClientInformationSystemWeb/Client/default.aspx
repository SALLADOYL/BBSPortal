                    ...
                    <td style="text-align: left; vertical-align: top;">
                        ...
                        <div>
                            ...
                            <asp:Panel ID="pnlServiceInfo" runat="server">
                                ...
                                background-color: cadetblue; text-align: left; vertical-align: top; padding: 8px; width: 400px;">
                            ...
                            <asp:Panel ID="pnlClServices" runat="server" Width="400px" Height="200px" style="display:none;">
                                <div style="background-color: cadetblue; padding:15px;">
                                    <table style="width:100%;">
                                        <tr>
                                            <td colspan="2"><h4>New Service Subscription</h4></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>
                                        <tr style="visibility:hidden; height:0px;">
                                            <td>Service ID:</td>
                                            <td><asp:TextBox ID="txtCLServiceID" runat="server" ReadOnly="true" Visible="false" ></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>Service Name:</td>
                                            <td><asp:DropDownList ID="ddServiceName" runat="server" Width="300px"></asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>
                            ...
                            <asp:Panel ID="pnlAttachmentModal" runat="server" Width="400px" Height="300px" style="display:none;">
                                <div style="background-color: coral; padding:15px;">
                                    <table style="width:100%;">
                                        <tr>
                                            <td colspan="2"><h4>Attach File</h4></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>
                                        <tr>
                                            <td>File ID:</td>
                                            <td><asp:TextBox ID="txtFILEID" runat="server" ReadOnly="true" ></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td>File:</td>
                                            <td><input type="file" id="fileInput1" runat="server" /></td>
                                        </tr>
                                        <%--<tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>--%>
                                        <tr>
                                            <td>Remarks:</td>
                                            <td><asp:TextBox ID="txtAttachmentRemarks" runat="server" Width="250px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>
                            ...
                            <asp:Panel ID="pnlNoteModal" runat="server" style="display:none; width:550px; height:300px;">
                                <div style="background-color: darkseagreen; padding:15px;">
                                    <table style="width:100%;">
                                        <tr>
                                            <td colspan="2"><h4>New Note</h4></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><hr /></td>
                                        </tr>
